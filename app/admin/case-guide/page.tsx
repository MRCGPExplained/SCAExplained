    ...
    <div>
      ...
      <Card title="Doctor's Brief" kicker="Candidate sees this — before the consult">
        ...
        <Field
          ...
          tip="Don't bury vitals or exam findings in a run-on sentence (&ldquo;BP 138/82, Pulse 78, no focal deficit, spinal tenderness…&rdquo;). Give each its own labelled table: start a line with &ldquo;## Heading&rdquo; (e.g. &ldquo;## Observations&rdquo;) to get a small bold section heading, then a pipe-table underneath it — &ldquo;Observation | Result&rdquo; / &ldquo;BP | 138/82 mmHg&rdquo; for vitals, &ldquo;System | Finding&rdquo; / &ldquo;Neurological | No focal deficit&rdquo; for exam findings. If Recent Notes includes an older colleague's entry (a past consultation, a letter, a discharge summary), set the WHOLE entry apart — findings table, Impression, and Plan together — by prefixing every line of it (including its blank lines) with &ldquo;&gt; &rdquo;; it renders as a shaded, bordered block, distinct from today's information. Only leave Impression and Plan as plain paragraphs outside the quote when they describe today's assessment, not a prior encounter being reported."
        />
