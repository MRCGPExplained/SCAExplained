      ...
      {showCreate && (
        <div className="rounded-2xl border border-navy/10 bg-white p-6 mb-6">
          ...
          <form onSubmit={handleCreate} className="grid grid-cols-2 gap-4">
            ...
            <div><label className="block text-[11px] font-bold text-navy/50 uppercase tracking-wide mb-1">First Name</label><input name="first_name" type="text" required placeholder="Jane" className="w-full border border-navy/20 rounded-lg px-3 py-2 text-[14px] outline-none focus:border-navy/50" /></div>
            <div><label className="block text-[11px] font-bold text-navy/50 uppercase tracking-wide mb-1">Last Name</label><input name="last_name" type="text" required placeholder="Smith" className="w-full border border-navy/20 rounded-lg px-3 py-2 text-[14px] outline-none focus:border-navy/50" /></div>
