  ...
  return (
    <div className="min-h-screen flex items-center justify-center px-4" style={{ background: "#FAFAF8" }}>
      <div className="w-full max-w-[400px]">
        ...
        >
          <h1 className="font-display font-bold text-[20px] mb-1" style={{ color: "#1A1B52" }}>
            Create account
          </h1>
          ...
          <form action={formAction}>
            ...
            <div className="mb-4">
              <label className="block text-[11px] font-bold uppercase tracking-[0.06em] mb-1.5" style={{ color: "rgba(26,27,82,0.5)" }}>
                Full name
              </label>
              <input
                name="display_name"
                ...
                style={{ border: "1.5px solid rgba(26,27,82,0.15)", color: "#1A1B52", background: "#F3F2FB", outline: "none" }}
              />
            </div>
            ...
            <button
              type="submit"
              disabled={pending}
              className="w-full rounded-lg py-3 font-display font-bold text-[14px] transition-opacity"
              style={{
                background: "#1A1B52",
                color: "white",
        ...
        <p className="text-center text-[12px] mt-6" style={{ color: "rgba(26,27,82,0.4)" }}>
          After registering you&apos;ll be directed to purchase 90-day access for £60.
        </p>
      </div>
    </div>
  );
