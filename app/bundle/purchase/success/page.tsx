...
export default function BundlePurchaseSuccessPage() {
  return (
    <div className="min-h-screen flex items-center justify-center px-4" style={{ background: "#FAFAF8" }}>
      <div className="w-full max-w-[440px] text-center">
        ...
        <p className="text-[14px] leading-[1.7] mb-6" style={{ color: "rgba(26,27,82,0.60)" }}>
          Your Video Course and Case Bank access are both active. Check your email for a confirmation.
        </p>
        <div className="flex gap-3 justify-center flex-wrap">
          <Link
            href="/video-course"
            className="inline-block rounded-xl px-6 py-3 font-display font-bold text-[14px] no-underline"
            style={{ background: "#F6D44B", color: "#1A1B52" }}
          >
            Video Course →
          </Link>
          <Link
