    ...
    <header className="sticky top-0 z-50 bg-cream/90 backdrop-blur-sm border-b border-navy/[0.07]">
      <div className="max-w-[1100px] mx-auto px-10 max-md:px-6 h-14 flex items-center justify-between">
        ...
        <Link href="/" className="flex items-center gap-2.5 no-underline group">
          <span className="w-8 h-8 rounded-full bg-navy flex items-center justify-center text-white font-display font-extrabold text-[15px] select-none group-hover:bg-navy/85 transition-colors">
            S
          </span>
