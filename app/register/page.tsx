    ...
    <div className="min-h-screen flex items-center justify-center px-4" style={{ background: "#FAFAF8" }}>
      <div className="w-full max-w-[400px]">
        ...
        <div className="rounded-2xl p-8" style={{ background: "white", border: "1px solid rgba(26,27,82,0.10)", boxShadow: "0 4px 24px rgba(26,27,82,0.07)" }}>
          <h1 className="font-display font-bold text-[20px] mb-1" style={{ color: "#1A1B52" }}>Create account</h1>
          <p className="text-[13px] mb-6" style={{ color: "rgba(26,27,82,0.5)" }}>
            Already have one?{" "}
            <Link href="/login" className="font-semibold no-underline" style={{ color: "#1A1B52" }}>
              Sign in
            </Link>
          </p>
          ...
          <form action={formAction}>
            ...
            <div className="mb-4">
              <label className="block text-[11px] font-bold uppercase tracking-[0.06em] mb-1.5" style={{ color: "rgba(26,27,82,0.5)" }}>Full name</label>
              <input name="display_name" type="text" required placeholder="Dr Jane Smith" autoComplete="name" className="w-full rounded-lg px-4 py-2.5 text-[13.5px]" style={{ border: "1.5px solid rgba(26,27,82,0.15)", color: "#1A1B52", background: "#F3F2FB", outline: "none" }} />
            </div>
            ...
            <div className="mb-6">
              ...
              <input name="password" type="password" required minLength={8} autoComplete="new-password" placeholder="8+ characters" className="w-full rounded-lg px-4 py-2.5 text-[13.5px]" style={{ border: "1.5px solid rgba(26,27,82,0.15)", color: "#1A1B52", background: "#F3F2FB", outline: "none" }} />
            </div>
        ...
        <p className="text-center text-[12px] mt-6" style={{ color: "rgba(26,27,82,0.4)" }}>
          After signing up you&apos;ll choose what to access.
        </p>
      </div>
    </div>
  );
